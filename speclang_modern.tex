...
\end{itemize}
\lstinline|\old(e)| and \result{} can be used only in \ensures{}, \assigns{}
and \allocates{} clauses, since
the other clauses already refer to the pre-state. The use of \result{} is also
subject to other restrictions:

\begin{itemize}
\item \result{} can not be used in the contract of a function that returns
  \void{};
\item in \assigns{} and \ensures{} clauses, a \result{} not directly inside an
